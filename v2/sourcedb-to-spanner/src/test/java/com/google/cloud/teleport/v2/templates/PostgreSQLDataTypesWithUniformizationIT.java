...
public class PostgreSQLDataTypesWithUniformizationIT extends SourceDbToSpannerITBase {
  private static final Logger LOG = LoggerFactory.getLogger(PostgreSQLDataTypesWithUniformizationIT.class);
  ...
  @Test
  public void allTypesTestWithUniformization() throws Exception {
    ...
    jobParameters.put("uniformizationStageCountHint", "7");
