...
public class RangePreparedStatementSetter<T extends Serializable>
    implements PreparedStatementSetter<Range<T>> {
  ...
  protected void setRangeParameters(
      @Nullable Range<T> element,
  ...
  public void setParameters(
      Range<T> element, @UnknownKeyFor @NonNull @Initialized PreparedStatement preparedStatement)
      throws @UnknownKeyFor @NonNull @Initialized Exception {
